...
public class DamsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sourcesRef = FirebaseDatabase.getInstance().getReference().child("Dams");
        return rootView;
    }
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<ServicesModel, DamsFragment.ProjectViewHolder> adapter =
                new FirebaseRecyclerAdapter<ServicesModel, DamsFragment.ProjectViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull DamsFragment.ProjectViewHolder holder, int position, @NonNull ServicesModel model) {
                    ...
                    @NonNull
                    @Override
                    public DamsFragment.ProjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.source_card_item, parent, false);

                        return new DamsFragment.ProjectViewHolder(view);
                    }
                };
