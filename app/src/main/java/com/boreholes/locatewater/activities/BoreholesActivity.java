...
public class BoreholesActivity extends AppCompatActivity implements FetchAddressTask.onTaskCompleted {
    ...
    private DatabaseReference boreholesRef,mDatabaseUsers,locationRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boreholes);
        ...
        boreholesRef = FirebaseDatabase.getInstance().getReference().child("Boreholes");
        ...
        Task<LocationSettingsResponse> result =
                LocationServices.getSettingsClient(BoreholesActivity.this).checkLocationSettings(builder.build());
                    ...
                    switch (exception.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                resolvable.startResolutionForResult(BoreholesActivity.this,
    ...
    private void getLocation() {
        ...
        if (ActivityCompat.checkSelfPermission( BoreholesActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(BoreholesActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(BoreholesActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION},
        ...
        mFusedLocationClient.getLastLocation().addOnCompleteListener(this,task -> {
            if (task.isSuccessful() && task.getResult() != null) {
                ...
                new FetchAddressTask(BoreholesActivity.this,
                        BoreholesActivity.this).execute(mLastLocation);
            } else {
    ...
    private boolean checkPermissions() {
        int permissionState = ActivityCompat.checkSelfPermission(BoreholesActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION);
        return permissionState == PackageManager.PERMISSION_GRANTED;
    }

    private void startLocationPermissionRequest() {
        ActivityCompat.requestPermissions(BoreholesActivity.this,
    ...
    public void validate() {
        ...
        final String sourceType = "Boreholes";
            ...
            if (longitude != null) {
                ...
                locationRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        newLocation.child("type").setValue("Boreholes");
                ...
                if (event_image_uri != null) {
                                ...
                                if (taskSnapshot.getMetadata().getReference() != null) {
                                    ...
                                    result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            final DatabaseReference newSurvey= boreholesRef.push();
                                            ...
                                            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                    ...
                                                    newSurvey.child("type").setValue("Boreholes");
                                                            ...
                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                ...
                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                    if (task.isSuccessful()) {
                                                                        ...
                                                                        Toast.makeText(BoreholesActivity.this, "Upload Complete", Toast.LENGTH_SHORT).show();
                                                                        final String postKey = newSurvey.getKey();

                                                                        progressBar.setVisibility(View.GONE);
                                                                        Intent next = new Intent(BoreholesActivity.this, VideoActivity.class);
                    ...
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(BoreholesActivity.this, "Please Add event photo", Toast.LENGTH_SHORT).show();
                }
            }else {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(BoreholesActivity.this,"Switch on GPS", Toast.LENGTH_SHORT).show();
            }
        }
    }
    @Override
