...
public class StepTwoBoreholesActivity extends AppCompatActivity {
    ...
    public void validate() {
        ...
        if (valid) {
            ...
            UploadBoreholeSubtotals.setBoreholesData(sources,fresh,salty,county,subCounty,ward);
    ...
    private void scheduleJob() {
        // [START dispatch_job]
        OneTimeWorkRequest work = new OneTimeWorkRequest.Builder(UploadBoreholeSubtotals.class)
                .build();
