...
public class BoreholesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_boreholes, container, false);
        ...
        sourcesRef = FirebaseDatabase.getInstance().getReference().child("Boreholes");
        return rootView;
    }
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<ServicesModel, BoreholesFragment.ProjectViewHolder> adapter =
                new FirebaseRecyclerAdapter<ServicesModel, BoreholesFragment.ProjectViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull BoreholesFragment.ProjectViewHolder holder, int position, @NonNull ServicesModel model) {
                    ...
                    @NonNull
                    @Override
                    public BoreholesFragment.ProjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.source_card_item, parent, false);

                        return new BoreholesFragment.ProjectViewHolder(view);
                    }
                };
