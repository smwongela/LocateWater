...
public class StepTwoDamsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        surveyRef = FirebaseDatabase.getInstance().getReference().child("Dams").child(post_key);
    ...
    public void validate() {
        ...
        if (valid) {
            ...
            UploadDamsSubtotals.setDamsData(sources,fresh,salty,county,subCounty,ward);
                    ...
                    surveyRef.child("ward").setValue(ward).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(StepTwoDamsActivity.this, " Upload Successful", Toast.LENGTH_SHORT).show();
                                ...
                                Intent next = new Intent(StepTwoDamsActivity.this, MainActivity.class);
    ...
    private void scheduleJob() {
        // [START dispatch_job]
        OneTimeWorkRequest work = new OneTimeWorkRequest.Builder(UploadDamsSubtotals.class)
                .build();
