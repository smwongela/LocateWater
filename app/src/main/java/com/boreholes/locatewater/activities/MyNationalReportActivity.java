...
public class MyNationalReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_national_report);
        ...
        if (currentUser == null) {
            ...
            Intent loginIntent = new Intent(MyNationalReportActivity.this, LoginActivity.class);
    ...
    private void updateCountyTotal() {
        mVillageCounts = FirebaseDatabase.getInstance().getReference().child("Kenya").child("Kenya");
    ...
    private void updateRiverTotal() {
        mRiverCounts = FirebaseDatabase.getInstance().getReference().child("Kenya").child("Kenya");
    ...
    private void updateLakeTotal() {
        mLakeCounts = FirebaseDatabase.getInstance().getReference().child("Kenya").child("Kenya");
    ...
    private void updateDamTotal() {
        mDamCounts = FirebaseDatabase.getInstance().getReference().child("Kenya").child("Kenya");
    ...
    private void updateSpringTotal() {
        mSpringCounts = FirebaseDatabase.getInstance().getReference().child("Kenya").child("Kenya");
    ...
    private void updateBoreholeTotal() {
        mBoreholeCounts = FirebaseDatabase.getInstance().getReference().child("Kenya").child("Kenya");
    ...
    private void updateTapTotal() {
        mTapCounts = FirebaseDatabase.getInstance().getReference().child("Kenya").child("Kenya");
