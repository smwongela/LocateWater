...
public class StepTwoTapsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        surveyRef = FirebaseDatabase.getInstance().getReference().child("Taps").child(post_key);
    ...
    public void validate() {
        ...
        if (valid) {
            ...
            UploadTapsSubTotals.setTapsData(sources,fresh,salty,county,subCounty,ward);
                    ...
                    surveyRef.child("ward").setValue(ward).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(StepTwoTapsActivity.this, " Upload Successful", Toast.LENGTH_SHORT).show();
                                ...
                                scheduleJob();
                                Intent next = new Intent(StepTwoTapsActivity.this, MainActivity.class);
    ...
    private void scheduleJob() {
        // [START dispatch_job]
        OneTimeWorkRequest work = new OneTimeWorkRequest.Builder(UploadTapsSubTotals.class)
                .build();
