...
public class UploadTapsSubTotals  extends Worker {  //private static final String TAG = UploadRiverSubtotals.class.getSimpleName();
    ...
    public UploadTapsSubTotals(@NonNull Context context, @NonNull WorkerParameters workerParams) {
        super(context, workerParams);
    }

    public static void setTapsData(String sources, String fresh,String salty,String county, String subCounty, String ward) {
        UploadTapsSubTotals.sources = sources;
        UploadTapsSubTotals.fresh = fresh;
        UploadTapsSubTotals.salty =salty;
        UploadTapsSubTotals.county =county;
        UploadTapsSubTotals.subCounty=subCounty;
        UploadTapsSubTotals.ward=ward;
    }
        ...
        if (sources != null && county != null && subCounty !=null) {
            ...
            countyRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    newCounty.child("totalTaps").setValue(sources);
                    newCounty.child("tapsFresh").setValue(fresh);
                    newCounty.child("tapsSalty").setValue(salty);
            ...
            subCountyRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    newSubCounty.child("totalTaps").setValue(sources);
                    newSubCounty.child("tapsFresh").setValue(fresh);
                    newSubCounty.child("tapsSalty").setValue(salty);
            ...
            wardRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    newWard.child("totalTaps").setValue(sources);
                    newWard.child("tapsFresh").setValue(fresh);
                    newWard.child("tapsSalty").setValue(salty);
