...
public class StepTwoLakesActivity extends AppCompatActivity {
    ...
    public void validate() {
        ...
        if (valid) {
            ...
            UploadLakesSubtotals.setLakeData(sources,fresh,salty,county,subCounty,ward);
    ...
    private void scheduleJob() {
        // [START dispatch_job]
        OneTimeWorkRequest work = new OneTimeWorkRequest.Builder(UploadLakesSubtotals.class)
                .build();
