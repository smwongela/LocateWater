                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                    ...
                                                    newSurvey.child("Taps").child("location").setValue(mLocation);
                                                    newSurvey.child("Taps").child("eventPhoto").setValue(eventImage);
                                                    newSurvey.child("Taps").child("village").setValue(village + " " + "Village");
