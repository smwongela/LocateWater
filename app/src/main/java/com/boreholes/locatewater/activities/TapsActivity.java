...
public class TapsActivity extends AppCompatActivity implements FetchAddressTask.onTaskCompleted {
    ...
    private DatabaseReference tapsRef,mDatabaseUsers,locationRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tapsRef = FirebaseDatabase.getInstance().getReference().child("Taps");
        ...
        Task<LocationSettingsResponse> result =
                LocationServices.getSettingsClient(TapsActivity.this).checkLocationSettings(builder.build());
                    ...
                    switch (exception.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                resolvable.startResolutionForResult(TapsActivity.this,
    ...
    private void getLocation() {
        ...
        if (ActivityCompat.checkSelfPermission( TapsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(TapsActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(TapsActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION},
        ...
        mFusedLocationClient.getLastLocation().addOnCompleteListener(this,task -> {
            if (task.isSuccessful() && task.getResult() != null) {
                ...
                new FetchAddressTask(TapsActivity.this,
                        TapsActivity.this).execute(mLastLocation);
            } else {
    ...
    private boolean checkPermissions() {
        int permissionState = ActivityCompat.checkSelfPermission(TapsActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION);
        return permissionState == PackageManager.PERMISSION_GRANTED;
    }

    private void startLocationPermissionRequest() {
        ActivityCompat.requestPermissions(TapsActivity.this,
            ...
            if (longitude != null) {
                ...
                locationRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        newLocation.child("type").setValue("Taps");
                ...
                if (event_image_uri != null) {
                                ...
                                if (taskSnapshot.getMetadata().getReference() != null) {
                                    ...
                                    result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            final DatabaseReference newSurvey= tapsRef.push();
                                            ...
                                            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                    ...
                                                    newSurvey.child("type").setValue("Taps");
                                                            ...
                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                ...
                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                    if (task.isSuccessful()) {
                                                                        ...
                                                                        Toast.makeText(TapsActivity.this, "Upload Complete", Toast.LENGTH_SHORT).show();
                                                                        final String postKey = newSurvey.getKey();

                                                                        progressBar.setVisibility(View.GONE);
                                                                        Intent next = new Intent(TapsActivity.this, VideoActivity.class);
                    ...
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(TapsActivity.this, "Please Add event photo", Toast.LENGTH_SHORT).show();
                }
            }else {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(TapsActivity.this,"Switch on GPS", Toast.LENGTH_SHORT).show();
            }
        }
    }
    @Override
