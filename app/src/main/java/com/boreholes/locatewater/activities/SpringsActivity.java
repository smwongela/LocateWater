...
public class SpringsActivity extends AppCompatActivity implements FetchAddressTask.onTaskCompleted  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_springs);
        ...
        Task<LocationSettingsResponse> result =
                LocationServices.getSettingsClient(SpringsActivity.this).checkLocationSettings(builder.build());
                    ...
                    switch (exception.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                resolvable.startResolutionForResult(SpringsActivity.this,
    ...
    private void getLocation() {
        ...
        if (ActivityCompat.checkSelfPermission( SpringsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(SpringsActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(SpringsActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION},
        ...
        mFusedLocationClient.getLastLocation().addOnCompleteListener(this,task -> {
            if (task.isSuccessful() && task.getResult() != null) {
                ...
                new FetchAddressTask(SpringsActivity.this,
                        SpringsActivity.this).execute(mLastLocation);
            } else {
    ...
    private boolean checkPermissions() {
        int permissionState = ActivityCompat.checkSelfPermission(SpringsActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION);
        return permissionState == PackageManager.PERMISSION_GRANTED;
    }

    private void startLocationPermissionRequest() {
        ActivityCompat.requestPermissions(SpringsActivity.this,
    ...
    public void validate() {
        ...
        final String sourceType = "Springs";
        ...
        if (valid) {
            ...
            if (longitude != null) {
                ...
                if (event_image_uri != null) {
                                                            ...
                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                ...
                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                    if (task.isSuccessful()) {
                                                                        ...
                                                                        Toast.makeText(SpringsActivity.this, "Upload Complete", Toast.LENGTH_SHORT).show();
                                                                        final String postKey = newSurvey.getKey();

                                                                        progressBar.setVisibility(View.GONE);
                                                                        Intent next = new Intent(SpringsActivity.this, VideoActivity.class);
                    ...
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(SpringsActivity.this, "Please Add event photo", Toast.LENGTH_SHORT).show();
                }
            }else {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(SpringsActivity.this,"Switch on GPS", Toast.LENGTH_SHORT).show();
            }
        }
    }
    @Override
