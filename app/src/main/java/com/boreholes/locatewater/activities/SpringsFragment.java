...
public class SpringsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_springs, container, false);
        ...
        sourcesRef = FirebaseDatabase.getInstance().getReference().child("Springs");
        return rootView;
    }
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<ServicesModel, SpringsFragment.ProjectViewHolder> adapter =
                new FirebaseRecyclerAdapter<ServicesModel, SpringsFragment.ProjectViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull SpringsFragment.ProjectViewHolder holder, int position, @NonNull ServicesModel model) {
                    ...
                    @NonNull
                    @Override
                    public SpringsFragment.ProjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.source_card_item, parent, false);

                        return new SpringsFragment.ProjectViewHolder(view);
                    }
                };
