...
public class MyCountyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_county);
        ...
        county_name = getIntent().getExtras().getString("CountyName");
        textViewCounty.setText(county_name);
        ...
        if (currentUser == null) {
            ...
            Intent loginIntent = new Intent(MyCountyActivity.this, LoginActivity.class);
    ...
    private void updateCountyTotal() {
        mVillageCounts = FirebaseDatabase.getInstance().getReference().child("Counties").child(county_name);
    ...
    private void updateRiverTotal() {
        mRiverCounts = FirebaseDatabase.getInstance().getReference().child("Counties").child(county_name);
    ...
    private void updateLakeTotal() {
        mLakeCounts = FirebaseDatabase.getInstance().getReference().child("Counties").child(county_name);
    ...
    private void updateDamTotal() {
        mDamCounts = FirebaseDatabase.getInstance().getReference().child("Counties").child(county_name);
    ...
    private void updateSpringTotal() {
        mSpringCounts = FirebaseDatabase.getInstance().getReference().child("Counties").child(county_name);
    ...
    private void updateBoreholeTotal() {
        mBoreholeCounts = FirebaseDatabase.getInstance().getReference().child("Counties").child(county_name);
    ...
    private void updateTapTotal() {
        mTapCounts = FirebaseDatabase.getInstance().getReference().child("Counties").child(county_name);
