...
public class MySubCountyReportActivity extends AppCompatActivity {
    String subCounty_name = null;
    private FirebaseAuth mAuth;
    private TextView textViewSubCounty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_sub_county_report);
        ...
        textViewSubCounty = findViewById(R.id.textViewSubCounty);
        subCounty_name = getIntent().getExtras().getString("SubCountyName");
        textViewSubCounty.setText(subCounty_name);
        ...
        if (currentUser == null) {
            ...
            Intent loginIntent = new Intent(MySubCountyReportActivity.this, LoginActivity.class);
    ...
    private void updateCountyTotal() {
        mVillageCounts = FirebaseDatabase.getInstance().getReference().child("SubCounties").child(subCounty_name);
    ...
    private void updateRiverTotal() {
        mRiverCounts = FirebaseDatabase.getInstance().getReference().child("SubCounties").child(subCounty_name);
    ...
    private void updateLakeTotal() {
        mLakeCounts = FirebaseDatabase.getInstance().getReference().child("SubCounties").child(subCounty_name);
    ...
    private void updateDamTotal() {
        mDamCounts = FirebaseDatabase.getInstance().getReference().child("SubCounties").child(subCounty_name);
    ...
    private void updateSpringTotal() {
        mSpringCounts = FirebaseDatabase.getInstance().getReference().child("SubCounties").child(subCounty_name);
    ...
    private void updateBoreholeTotal() {
        mBoreholeCounts = FirebaseDatabase.getInstance().getReference().child("SubCounties").child(subCounty_name);
    ...
    private void updateTapTotal() {
        mTapCounts = FirebaseDatabase.getInstance().getReference().child("SubCounties").child(subCounty_name);
