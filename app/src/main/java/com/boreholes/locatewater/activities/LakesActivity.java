...
public class LakesActivity extends AppCompatActivity implements FetchAddressTask.onTaskCompleted {
    ...
    private DatabaseReference lakesRef,mDatabaseUsers,locationRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lakesRef = FirebaseDatabase.getInstance().getReference().child("Lakes");
        ...
        Task<LocationSettingsResponse> result =
                LocationServices.getSettingsClient(LakesActivity.this).checkLocationSettings(builder.build());
                    ...
                    switch (exception.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                resolvable.startResolutionForResult(LakesActivity.this,
    ...
    private void getLocation() {
        ...
        if (ActivityCompat.checkSelfPermission( LakesActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(LakesActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(LakesActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION},
        ...
        mFusedLocationClient.getLastLocation().addOnCompleteListener(this,task -> {
            if (task.isSuccessful() && task.getResult() != null) {
                ...
                new FetchAddressTask(LakesActivity.this,
                        LakesActivity.this).execute(mLastLocation);
            } else {
    ...
    private boolean checkPermissions() {
        int permissionState = ActivityCompat.checkSelfPermission(LakesActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION);
        return permissionState == PackageManager.PERMISSION_GRANTED;
    }

    private void startLocationPermissionRequest() {
        ActivityCompat.requestPermissions(LakesActivity.this,
            ...
            if (longitude != null) {
                ...
                locationRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        newLocation.child("type").setValue("Lakes");
                ...
                if (event_image_uri != null) {
                                ...
                                if (taskSnapshot.getMetadata().getReference() != null) {
                                    ...
                                    result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            final DatabaseReference newSurvey= lakesRef.push();
                                            ...
                                            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                    ...
                                                    newSurvey.child("type").setValue("Lakes");
                                                            ...
                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                ...
                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                    if (task.isSuccessful()) {
                                                                        ...
                                                                        Toast.makeText(LakesActivity.this, "Upload Complete", Toast.LENGTH_SHORT).show();
                                                                        final String postKey = newSurvey.getKey();

                                                                        progressBar.setVisibility(View.GONE);
                                                                        Intent next = new Intent(LakesActivity.this, VideoActivity.class);
                    ...
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(LakesActivity.this, "Please Add event photo", Toast.LENGTH_SHORT).show();
                }
            }else {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(LakesActivity.this,"Switch on GPS", Toast.LENGTH_SHORT).show();
            }
        }
    }
    @Override
